        ...
        <div class="col-md-4 offset-md-4">
          <form action="<?= site_url('supplier/process'); ?>" method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control " id="supplier_name" name="supplier_name" value="<?= $row->name; ?>" required autofocus>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea type="text" class="form-control " id="desc" name="desc"><?= $row->description; ?></textarea>
            </div>
            <div class="form-group">
